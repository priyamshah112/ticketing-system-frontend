                    ...
                    <li className="nav-item dropdown hidden-caret">
                        <a className="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                            <div className="avatar-sm">
                                <img src="/images/user/user.png" alt="..." className="avatar-img rounded-circle" />
                            </div>
                        </a>
                            ...
                            <div className="dropdown-user-scroll scrollbar-outer">
                                <li>
                                    <div className="user-box">
                                        <div className="avatar-lg"><img src="/images/user/user.png" alt="image profile" className="avatar-img rounded" /></div>
