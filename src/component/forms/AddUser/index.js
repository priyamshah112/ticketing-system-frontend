        ...
        <form onSubmit={(e) => { e.preventDefault(); onSubmit(formdata, setFormdata) }}>
            <div className="row">
                ...
                <div className="col-lg-6 col-md-6 col-6 mt-3">
                    ...
                    <input type="email" value={formdata !== null ? formdata.email : ''} onChange={(e) => setFormdata({ ...formdata, email: e.target.value })} className="form-control" />
                    {/* </div> */}
                </div>
                ...
                <div className="col-12 px-4 mt-3 text-right">
                    ...
                    <input type="button" className="btn btn-danger ml-3" onClick={()=>{setFormdata(null);onCancel()}} value={"Close"} />
                </div>
            </div>
        </form>
    )
