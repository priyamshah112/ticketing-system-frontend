    ...
    <div className="sidebar-wrapper scrollbar scrollbar-inner">
      <div className="sidebar-content">
        <div className="user">
          ...
          <div className="info">
            ...
            <div className="collapse in" id="collapseExample">
              <ul className="nav">
                <li>
                  <a href="/changepassword" onClick={(e) => {
                      e.preventDefault();
        ...
        <ul className="nav nav-primary">
          {userType !== "Support" && (
            <li class="nav-item active" id="dashboard" onClick={() => activeLinkHandler("dashboard")}>
                <Link
            ...
            <li className="nav-item" id="inventory-main" onClick={() => activeLinkHandler("inventory-main")}>                
              ...
              <div className="collapse" id="inventory">
                <ul className="nav nav-collapse">
                  <li id="inv-software" onClick={() => activeLinkHandler("inv-software")}>
                    <Link to="/inventory/software">
                      <span className="sub-item">Software</span>
                    </Link>
                  </li>
                  <li id="inv-hardware">
                    <Link to="/inventory/hardware" onClick={() => activeLinkHandler("inv-hardware")}>
          ...
          {userType !== "Support" && userType !== "User" && (
            <li className="nav-item" id="user-main" onClick={() => activeLinkHandler("user-main")}>
              ...
              <div className="collapse" id="user">
                <ul className="nav nav-collapse">
                  <li id="user-role" onClick={() => activeLinkHandler("user-role")}>
                    <Link to="/role">
                      <span className="sub-item">Roles</span>
                    </Link>
                  </li>
                  <li id="user-sub-user" onClick={() => activeLinkHandler("user-sub-user")}>
                    <Link to="/user">
